...
final class NetworkingTests: XCTestCase {
    ...
    func testRequestURL() throws {
        ...
        let parameters: Set<WeatherQueryParameter> = [.swellHeight, .airTemperature]
        ...
        let request = try StormGlassKit.weatherURLRequest(coordinate: coordinate, parameters: parameters, start: start, end: end, sources: nil)
